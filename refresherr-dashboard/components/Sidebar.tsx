...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
  const navItems = [
    ...
    { id: 'symlinks', label: 'Symlinks', icon: (
  ...
  return (
    <div className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col h-screen fixed">
      <div className="p-6 flex items-center space-x-3">
        ...
        <h1 className="text-xl font-bold tracking-tight bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">Refresherr</h1>
      </div>
      ...
      <div className="mt-auto p-4">
        <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700">
          ...
          <p className="text-xs text-slate-400">Ver 1.2.4-stable</p>
        </div>
      </div>
    </div>
  );
